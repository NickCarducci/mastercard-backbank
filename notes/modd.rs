...
impl Clone for worker::Response {
  fn clone(&self) -> Self {//Self is enum for Foo struct
    Foo {
      a: self.a.clone(),
      b: self.b.clone(),
      c: self.c.clone(),
...
//https://community.cloudflare.com/t/using-authorization-credential-bearer-in-lieu-of-same-origin/409702
//use cloudflare::framework::auth::Credentials;
//https://docs.rs/wrangler/1.12.1/src/wrangler/kv/bulk.rs.html
//https://github.com/cloudflare/cloudflare-rs/search?p=2&q=account_identifier&type=code
//mod routescript;
//routescript(&HeaderValue::from_str(&get_user_agent(feature)).unwrap())


/*use async_trait::async_trait;
//https://github.com/cloudflare/workers-rs/blob/78a72a4f52fc4a8bfa01d25ca92fafa807290150/worker-macros/src/durable_object.rs#L96
