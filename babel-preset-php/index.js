...
export function renameException(babel) {
    const t = babel.types;
    return {
        visitor: {
            Identifier(p) {
...
export function isDefined(babel) {
    const t = babel.types;
    return {
        visitor: {
            CallExpression(p) {
...
export function functionExists(babel) {
    const t = babel.types;
    return {
        visitor: {
            CallExpression(p) {
...
export function arrayFunctions(babel) {
    const t = babel.types;
    return {
        visitor: {
            CallExpression(p) {
...
export function stringFunctions(babel) {
    const t = babel.types;
    return {
        visitor: {
            CallExpression(p) {
...
export function mathFunctions(babel) {
    const t = babel.types;
    return {
        visitor: {
            CallExpression(p) {
...
export function superglobals(babel) {
    const t = babel.types;
    return {
        visitor: {
            Identifier(p) {
...
export function otherFunctions(babel) {
    const t = babel.types;
    return {
        visitor: {
            CallExpression(p) {
...
export function defineToConstant(babel) {
    const t = babel.types;
    let inFunction = 0;
    return {
        visitor: {
 ...
 */
function syntaxPlugin(api, options) {
    api.assertVersion(7);
    return {
        name: "syntax-php",
