  ...
  constructor() {
    ...
    */
      ...
      BUILD = (variables.REQUIREJS = (
        ...
        if (!STATE)
          ...
          STATE = contexts[NAME] = class newRequireable {
            constructor() {
              const NAME = arguments[0],
                state = {
                  ...
                  enabledRegistry: STATE.enabledRegistry
                    ? STATE.enabledRegistry
                    : {},
                  ...
                  completeLoad: (tkn) => {
                    ...
                    STATE.defQueueMap = {};
                    var m = ((d) => e_(d).yes(tkn) && d[tkn])(
                      STATE.dependencies
                    ); // in case-/init-calls change the STATE.dependencies
                    if (
                      !found &&
    ...
    function checkLoaded(parentThis = arguments[0]) {
      ...
      _K(STATE.enabledRegistry).forEach(
        (
          { id, noCyc } = (mod = (x) => STATE.enabledRegistry[x]) =>
            ((
    ...
    */
    ...
    var baseElement,
      ...
      clrRegstr = (id) =>
        delete STATE.dependencies[id] && delete STATE.enabledRegistry[id],
      iserror = (err) =>
