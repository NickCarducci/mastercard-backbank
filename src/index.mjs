export class DurableObjectExample {
  constructor(el, env) {
    ...
    this.makeRequire = async (req) => {
      ...
      return await gotten.fetch(
        //fetch require request, build product (of Require), Require product
        req,
        env
      ); /*.then((res) => {
        ...
        .then(async (res) => {
          ...
          readable
            ...
            .then(function processText({ done, value }) {
              ...
              return readable.read().then(processText); // Read some more, and call this function again
            })
            .then((requirer) => {
              console.log(
              ...
              return cors(req, (res = null), async () => {
                  ...
                  if (req.method === "OPTIONS") {
                    ...
                    return new Response(
                      ...
                      ),
                      {
                        ...
                        message: "not ready for use",
                        statusText:
                          "successful header check for POST process- " +
                          req.url,
                        headers: {
                          ...dataHead,
