...
require = (function (global, setTimeout) {
  var req,
    s,
    head,
    baseElement,
  ...
  req.exec = function (text) {
    /*jslint evil: true */
    return new Promise((resolve, reject) => new Function('resolve',`"use strict";return (${text})`)(resolve,text);//eval(text);
                      );
  };
...
function Required () {return{require,define}};
